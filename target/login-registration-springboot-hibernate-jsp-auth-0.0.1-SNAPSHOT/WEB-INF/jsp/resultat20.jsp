          ...
          <div class="row">
            ...
            <div class="row">
                       ...
                       <div class="card-box table-responsive">
                               ...
                               <table id="resultat20" class="table table-bordered" style="width:100%">
                      <thead>
                        <tr role="row">
                         <th></th>
                        <th>Date</th>
...
<script data-config="">
    ...
    var tf = new TableFilter('resultat20', filtersConfig);
    tf.init();
    
    $(document).ready(function() {
        $('#resultat20').DataTable( {
            dom: 'Bfrtip',
            buttons: [
