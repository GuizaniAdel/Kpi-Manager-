                  ...
                  <form id="demo-form2" data-parsley-validate="" method="POST" class="form-horizontal form-label-left"   >
                      ...
                      <thead>
                        ...
                        <th>Date</th>
                          ...
                          <th> GAP</th>
                          <th> GAP %</th>
                           <th> Nbre Records DB1</th>
                            <th>  Nbre Records DB2</th>
                             <th> Nbre Records OK</th>
                      ...
                      <tbody>
                        ...
                        <td>${u.getVal_kpi1()}</td> 
                         <td>${u.getVal_kpi2()}</td>
                         <td>${u.getGap()} </td> 
                         <td> <span style='background-color:#F88;display:block;width:${u.getGAP_par_100()}%'>${u.getGAP_par_100()}%</span> </td> 
                         <td>${u.getLoad1()}</td> 
                         <td>${u.getLoad2()}</td>
...
<script data-config="">
    ...
    var tf = new TableFilter('datatable-buttons', filtersConfig);
    tf.init();
    </script>
</body>
</html>