    ...
    <div class="container body">
      ...
      <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                   ...
                   <%--     <th>Date</th>--%>  
                          <th >Code_requete</th>
                          <th>Name_kpi</th>
                          <th>Total Kpi in <%= DbServiceImpl.getRecordById(Long.parseLong(request.getParameter("db1"))).getName()%></th>
                          <th>Total Kpi in <%= DbServiceImpl.getRecordById(Long.parseLong(request.getParameter("db2"))).getName()%></th>
                          <th> GAP</th>
                          <th> GAP %</th>
                          <th> Data Quality</th>
                            <th> Acceptation</th>
